export default {
    functionlist: {
        ...
        IFS: {
            d: "Returns one value if a logical expression is `TRUE`",
            a: "Checks whether one or more conditions are met and returns a value corresponding to the first TRUE condition.",
            p: [
                {
                    name: "logical_expression",
                    detail:
